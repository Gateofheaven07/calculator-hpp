    ...
    <AuthLayout>
      <div className="relative z-20 w-full backdrop-blur-2xl bg-[#0f172a]/70 rounded-[2rem] p-6 border border-white/20 shadow-[0_0_50px_rgba(0,0,0,0.8)] ring-1 ring-white/10 overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-6">
            ...
            <h1 className="text-3xl font-bold text-center text-white tracking-wide mt-1 drop-shadow-lg">Join HPP</h1>
            <p className="text-center text-gray-300 text-sm font-mono mt-1 tracking-wider">Automated Precision Calculation</p>
        </div>
        ...
        <form action={action} className="space-y-4">
            ...
            <button 
                className="w-full py-3 mt-4 rounded-xl btn-gradient text-white font-bold text-lg tracking-widest uppercase hover:tracking-[0.2em] transition-all duration-300 transform active:scale-95 border border-white/20 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed" 
                type="submit"
                disabled={isPending}
            >
                {isPending ? (
            ...
            <div className="flex justify-between items-center text-sm mt-8 px-2 font-mono">
                <span className="text-gray-400">Already initialized?</span>
                <Link className="font-bold text-accent-yellow hover:text-primary transition-colors hover:shadow-[0_2px_0_currentColor]" href="/login">Access Terminal →</Link>
            </div>
        </form>
